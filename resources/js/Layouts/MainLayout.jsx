                        ...
                        <div className="hidden md:flex items-center space-x-10">
                            {navLinks.map((link) => (
                                <Link
                                    key={link.name}
                                    href={link.href}
                                    className={`text-[11px] font-bold tracking-[0.2em] transition-all duration-300 uppercase relative group/link ${route().current(link.href)
                    ...
                    <div className="pt-2 pb-3 space-y-1 px-4">
                        {navLinks.map((link) => (
                            <Link
                                key={link.name}
                                href={link.href}
                                className={`block py-3 text-base font-medium transition-all ${route().current(link.href) ? 'text-gold' : 'text-cream-gold'
                                    }`}
