        ...
        >
            ...
            <div className="py-8 bg-hitam-pekat min-h-screen">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
                    ...
                    {/* Welcome Banner */}
                    <div className="relative overflow-hidden bg-coklat-kopi/40 border border-gold/10 rounded-2xl p-8 md:p-12 shadow-2xl backdrop-blur-sm">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
                            <div className="space-y-4">
                                <div className="inline-flex items-center space-x-2 px-4 py-1.5 bg-gold/10 rounded-full backdrop-blur-md border border-gold/20">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gold-muda">Akses Administratif</span>
                                </div>
                                <h1 className="text-4xl md:text-5xl font-black text-cream-gold tracking-tighter uppercase italic">
                                    Selamat Datang, <span className="text-gold">{auth.user.name}</span>
                                </h1>
                                <p className="text-gray-400 text-sm font-bold uppercase tracking-widest max-w-lg leading-relaxed">
                                    Anda memegang kendali ekosistem Master Cigars & Coffee. Semuanya tersinkronisasi dan siap.
                                </p>
                            </div>
                            <div className="flex gap-4">
                                <div className="bg-gold/5 border border-gold/10 p-6 rounded-2xl text-center min-w-[120px] backdrop-blur-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {stats.map((item, idx) => (
                            <Link
                                key={idx}
                                href={item.link}
                                className="group bg-coklat-kopi/10 p-6 rounded-2xl border border-gold/5 shadow-sm hover:shadow-gold/5 hover:shadow-2xl hover:border-gold/30 transition-all duration-500 flex flex-col items-center text-center relative overflow-hidden active:scale-95 backdrop-blur-sm"
                            >
                    ...
                    <div className="bg-coklat-kopi/5 rounded-2xl border border-gold/5 p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-sm">
                        <div className="flex items-center space-x-6">
                            ...
                            <div>
                                <h4 className="text-lg font-black text-cream-gold tracking-tight uppercase">Integritas Sistem: 100%</h4>
                                <p className="text-xs text-cream-gold/30 font-black uppercase tracking-[0.1em]">Semua layanan berjalan normal</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap gap-4 justify-center">
                            <span className="px-5 py-2 bg-gold/5 border border-gold/10 rounded-full text-[10px] font-black uppercase tracking-widest text-gold/60">Database Aktif</span>
                            <span className="px-5 py-2 bg-gold/5 border border-gold/10 rounded-full text-[10px] font-black uppercase tracking-widest text-gold/60">Penyimpanan Sinkron</span>
                            <span className="px-5 py-2 bg-gold/5 border border-gold/10 rounded-full text-[10px] font-black uppercase tracking-widest text-gold/60">Terinkripsi SSL</span>
                        </div>
                    </div>
                </div>
            </div>
