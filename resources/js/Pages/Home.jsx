        ...
        <MainLayout>
            ...
            <section className="relative h-screen flex items-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-4xl space-y-8 animate-fade-in-up">
                        <div className="flex items-center space-x-4 mb-2">
                            ...
                            <span className="text-gold uppercase tracking-[0.5em] text-[10px] font-black italic">{__('home.hero.sub')}</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 pt-6">
                            ...
                            >
                                ...
                                <span className="relative z-10 flex items-center space-x-4">
                                    <span>{__('home.hero.explore')}</span>
                            ...
                            >
                                ...
                                <span className="relative z-10">{__('home.hero.story')}</span>
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-4 opacity-20">
                    ...
                    <span className="text-[8px] uppercase tracking-[0.3em] font-black text-gold">{__('home.hero.scroll')}</span>
                </div>
            </section>
            ...
            <section className="py-32 bg-hitam-pekat relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-gold/20 border border-gold/20 shadow-2xl">
                        {[
                            { title: __('home.features.f1_title'), desc: __('home.features.f1_desc'), icon: FireIcon },
                            { title: __('home.features.f2_title'), desc: __('home.features.f2_desc'), icon: BeakerIcon },
                            { title: __('home.features.f3_title'), desc: __('home.features.f3_desc'), icon: SparklesIcon }
                        ].map((feature, idx) => (
