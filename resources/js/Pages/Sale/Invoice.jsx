            ...
            <section className="py-16 md:py-24 bg-hitam-pekat min-h-screen">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 md:mb-8 bg-gold/10 border border-gold/30 rounded-xl p-4 flex items-start space-x-3 md:space-x-4 animate-fade-in-up">
                        ...
                        <div>
                            <h3 className="text-gold font-black uppercase text-[9px] md:text-[10px] tracking-widest mb-1">Perhatian Penting</h3>
                            <p className="text-white/80 text-[9px] md:text-[10px] leading-relaxed">
                                Harap <strong className="text-white font-bold">Screenshot (Tangkap Layar)</strong> halaman ini atau simpan ID Tracking Anda. Kode id tracking wajib disimpan sebagai satu-satunya cara melacak status pesanan Anda.
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="bg-[#16120e] border border-white/10 rounded-xl md:rounded-2xl overflow-hidden shadow-xl">
                                <div className="p-5 md:p-6 border-b border-white/5 bg-linear-to-r from-gold/10 to-transparent">
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                                        <div>
                                            <span className="text-gold text-[9px] md:text-[10px] font-black uppercase tracking-widest block mb-2 opacity-60">Status Pesanan</span>
                                        ...
                                        <div className="text-left sm:text-right">
                                            <span className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest block mb-1">Invoice Number</span>
                                ...
                                <div className="p-5 md:p-6 space-y-4 md:space-y-6">
                                    ...
                                    <div className="pt-5 md:pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-start md:items-end gap-2 md:gap-0">
                                        <div>
                                            <span className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest block mb-1">Total Pembayaran</span>
                                        ...
                                        <div className="text-left md:text-right">
                                            <p className="text-white/20 text-[8px] md:text-[9px] font-bold italic uppercase tracking-widest">Sudah termasuk PPN & Biaya Layanan</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#16120e] border border-white/10 rounded-xl md:rounded-2xl p-5 md:p-6 shadow-xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <div className="space-y-4">
                                        {settings.bank_accounts && settings.bank_accounts.map((acc, index) => (
                                            <div key={index} className="p-4 bg-white/5 rounded-xl border border-white/5">
                                                <span className="text-gold text-[8px] md:text-[9px] font-black uppercase tracking-widest block mb-2 md:mb-3 opacity-60">Transfer {acc.bank}</span>
                                    ...
                                    <div className="flex flex-col items-center justify-center p-4 md:p-6 bg-white rounded-xl">
                                        <span className="text-hitam-pekat text-[8px] md:text-[9px] font-black uppercase tracking-widest block mb-3 md:mb-4 opacity-100">Scan QRIS untuk Bayar</span>
                                        ...
                                        <p className="text-hitam-pekat/40 text-[7px] md:text-[8px] font-bold uppercase text-center leading-tight">Mendukung All E-Wallet & Mobile Banking</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6 md:sticky md:top-24 h-fit">
                            <div className="bg-[#16120e] border border-gold/30 rounded-xl md:rounded-2xl p-5 md:p-6 text-white shadow-xl shadow-gold/5 flex flex-col h-full">
                                <div className="flex items-center space-x-4 mb-6 md:mb-8">
                                    ...
                                    <div>
                                        <span className="text-white/40 text-[9px] md:text-[10px] font-black uppercase tracking-widest block leading-none mb-1">Status Pembayaran</span>
                                ...
                                <div className="p-4 md:p-5 bg-gold/10 rounded-xl border border-gold/20 mb-6 md:mb-8">
                                    <span className="text-gold/60 text-[8px] md:text-[9px] font-black uppercase tracking-widest block mb-1">ID Tracking Anda</span>
                                    <div className="flex justify-between items-center">
                                    ...
                                    <p className="text-white/40 text-[8px] md:text-[9px] font-bold uppercase mt-2 md:mt-3 italic leading-tight">*Simpan ID Tracking ini. Admin akan memverifikasi pesanan Anda (5-10 mnt).</p>
                                </div>
